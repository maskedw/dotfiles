...
" @note
" vim-airline‚ğg—p‚µ‚Ä‚¢‚é‚ÆA”çs‚ ‚éƒtƒ@ƒCƒ‹‚ğŠJ‚¢‚½‚ÉƒNƒ\d‚­‚È‚Á‚½‚Ì
" ‚Å‚â‚ßBlightline‚Éæ‚èŠ·‚¦‚½B
...
" @note
" ‚Ç‚¤‚à‘¼‚ÌC/C++ƒvƒ‰ƒOƒCƒ“‚àLazy‚É‚µ‚Ä‚¢‚é‚ÆAclang_complete‚Ì•âŠ®‚ªŒø‚©‚È‚­
" ‚È‚é‚ª‚ ‚éB‚æ‚­‚í‚©‚ç‚ñ‚ªAclang_complete‚¾‚¯Lazy‚É‚µ‚Ä‚¨‚­B
