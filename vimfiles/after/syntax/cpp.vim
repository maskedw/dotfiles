...
highlight link qClass cppType


syn keyword maskedwCast mw_rtti_cast
syn keyword maskedwCast mw_strict_rtti_cast
syn keyword maskedwMacro MW_STATIC_ASSERT
syn keyword maskedwMacro MW_FOREACH MW_FOREACH_NOT_ADVANCE MW_RFOREACH MW_RFOREACH_NOT_ADVANCE
syn keyword maskedwMacro MW_NEW MW_DELETE MW_DELETE_ARRAY MW_SAFE_DELETE MW_SAFE_DELETE_ARRAY
syn keyword maskedwMacro MW_D MW_Q MW_DECLARE_SINGLETON MW_DECLARE_PRIVATE MW_DECLARE_PUBLIC
syn keyword maskedwMacro MW_DISALLOW_COPY_AND_ASSIGN
syn keyword maskedwMacro MW_DECLARE_RTTI
syn keyword maskedwMacro MW_SAFE_RETAIN MW_SAFE_RELEASE

syn keyword gengineMacro GE_BREAK_IF GE_BREAK_AND_WARN_IF
syn keyword gengineMacro GE_LOG_VERB GE_LOG_INFO GE_LOG_NOTI GE_LOG_WARN GE_LOG_ERR
syn keyword gengineMacro GE_VRAM_ALLOCATE GE_VRAM_DEALLOCATE GE_VRAM_SAFE_DEALLOCATE GE_VRAM_IS_OWNER
syn keyword gengineMacro GE_APP_UPDATE_LOOPER GE_APP_POST_CALLBACK
syn keyword gengineMacro GE_ASSERT GE_ASSERT_MSG GE_ASSERT_X


highlight link maskedw cppType
highlight link gengine cppType
highlight link maskedwCast  cppCast
highlight link maskedwMacro cppStatement
highlight link gengineMacro cppStatement
